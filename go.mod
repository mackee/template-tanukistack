module github.com/mackee/template-tanukistack

go 1.23.5

tool (
	github.com/mackee/go-genddl/cmd/genddl
	github.com/mackee/go-sqlla/v2/cmd/sqlla
...
require (
	...
	github.com/mackee/go-sqlla/v2 v2.99.0-rc1
